...
class PediaLeader:
	...
	def interfaceScreen(self, iLeader):
		...
		if CvLeaderHeadInfo.isNPC():
			szName += " (NPC)"
		screen.setText(self.main.getNextWidgetName(), "", szName, 1<<0, X_COL_1, 0, 0, FontTypes.TITLE_FONT, iWidGen, 0, 0)
		screen.addPanel(self.main.getNextWidgetName(), "", "", False, False, X_COL_1, Y_ROW_1, W_COL_1, H_ROW_1, PanelStyles.PANEL_STYLE_MAIN)
		screen.addDDSGFC(self.main.getNextWidgetName(), CvLeaderHeadInfo.getLeaderHead(), X_COL_1+12, Y_ROW_1+12, W_COL_1-24, H_ROW_1-24, iWidGen, -1, -1)

		# Civilization
		panelName = self.main.getNextWidgetName()
		screen.addPanel(panelName, "", "", False, True, X_COL_1, Y_ROW_2, W_COL_1, H_BOT_ROW, iPanelBlue50)
		screen.attachLabel(panelName, "", "  ")
		screen.attachImageButton(panelName, "", CvLeaderHeadInfo.getButton(), enumGBS, iWidGen, iLeader, 0, False)
		...
		panelName = self.main.getNextWidgetName()
		screen.addPanel(panelName, TRNSLTR.getText("TXT_KEY_PEDIA_FAV_CIVIC_AND_RELIGION", ()), "", False, True, X_COL_1, Y_ROW_3, W_COL_1, H_BOT_ROW, iPanelBlue50)
		screen.attachLabel(panelName, "", "  ")
		...
		# History
		screen.addPanel(self.main.getNextWidgetName(), "", "", True, True, X_COL_2, Y_ROW_1, W_COL_2, H_ROW_1, iPanelBlue50)
		szText = szfont3 + CvLeaderHeadInfo.getCivilopedia()
		screen.addMultilineText(self.main.getNextWidgetName(), szText, X_COL_2+4, Y_ROW_1+16, W_COL_2-8, H_ROW_1-32, iWidGen, 0, 0, 1<<0)

		# Traits
		panelName = self.main.getNextWidgetName()
		screen.addPanel(panelName, "", "", True, False, X_COL_2, Y_ROW_2, W_COL_2, H_ROW_2, iPanelBlue50)
		listName = self.main.getNextWidgetName()
		szSpecialText = szfont3 + CyGameTextMgr().parseLeaderTraits(iLeader, -1, False, True)[1:]
		screen.addMultilineText(listName, szSpecialText, X_COL_2+4, Y_ROW_2+16, W_COL_2-8, H_ROW_2-32, iWidGen, -1, -1, 1<<0)

		# Personality
		panelName = self.main.getNextWidgetName()
		screen.addPanel(panelName, "", "", True, True, X_COL_1, Y_ROW_4, W_COL_1, H_ROW_4, iPanelBlue50)
		...
		screen.addMultilineText(self.main.getNextWidgetName(), szStatsText, X_COL_1+4, Y_ROW_4+16, W_COL_1-8, H_ROW_4-32, iWidGen, -1, -1, 1<<0)
