...
def toggleSetNoScreens():
	...
	g_iScreenActive = MAIN_INTERFACE
...
'''
	if g_iScreenActive != MAIN_INTERFACE or mainInterface.bPlotHelpBan: return
	print "exe tooltip"
	CyIF = CyInterface()
	if not (CyIF.isFocused()
	or CyIF.isRightMouseDown()
	or CyIF.isLeftMouseDown()
	or CyIF.getInterfaceMode() in (InterfaceModeTypes.INTERFACEMODE_GO_TO, InterfaceModeTypes.INTERFACEMODE_ROUTE_TO)
	):
		print "banPlotHelp"
		mainInterface.banPlotHelp()
'''
