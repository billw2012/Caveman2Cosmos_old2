...
### Since we use Platyping's World Builder I have not bothered to updated this to BUG 4.4
##
## DH 2016 remove ref to isPermanentWarPeace in setDiplomacyEditInfo(self)
...
## Food ##
		self.m_tabCtrlEdit.addSectionLabel(localText.getText("TXT_KEY_WB_FOOD",(pCity.growthThreshold(),)),  0)
...
## Team ##
		self.m_tabCtrlEdit.addSectionButton(localText.getText("TXT_KEY_WB_TEAM_DATA",(self.m_iCurrentTeam,))+"\b\b\b\b\b\b", "CvScreensInterface", "WorldBuilderHandleEnterNewScreenCB", "TeamEditScreen", 0)
## Current Era ##
		strTest = ()
...
##
		for i in range (iColumnLength - 8 - gc.getNumCivicOptionInfos()):
			self.m_tabCtrlEdit.addSectionLabel(" ",  0)
## Kill ##
		self.m_tabCtrlEdit.addSectionButton(localText.getText("TXT_KEY_WB_KILL",())+"\b\b\b\b\b\b", "CvScreensInterface", "WorldBuilderHandleKillCB", "Player", 0)
...
## Game Options ##
		self.m_tabCtrlEdit.addSectionButton(localText.getText("TXT_KEY_WB_GAME_OPTION",())+"\b\b\b\b\b\b", "CvScreensInterface", "WorldBuilderHandleEnterNewScreenCB", "GameOptionEditScreen", 0)
## Game Script ##
		self.m_tabCtrlEdit.addSectionLabel(localText.getText("TXT_KEY_WB_SCRIPT_DATA",()),  0)
		...
		if self.m_iDiplomacyPage == 0:
			...
			for i in lOthers:
				...
				for iAttitude in range(5):
					strTest = strTest + (gc.getAttitudeInfo(iAttitude).getDescription() + " " + localText.getText("TXT_KEY_WB_TOWARDS",(pPlayer.getName(),)),)
...
## Side Panel ##
	...
	def setSideMenu(self):
		...
		if (CyInterface().isInAdvancedStart()):
			...
			screen.setImageButtonAt( "WorldBuilderGameDataButton", "WorldBuilderLoadSavePanel", ArtFileMgr.getInterfaceArtInfo("WORLDBUILDER_CHANGE_ALL_PLOTS").getPath(), iButtonX, iButtonY, iButtonWidth, iButtonHeight, WidgetTypes.WIDGET_GENERAL, -1, -1)
...
## Game Data Start##
				...
				screen.addPullDownString(szDropdownName, localText.getText("TXT_KEY_WB_PLAYER_DATA",(self.m_iCurrentPlayer,)), 0, 0, True )
				screen.addPullDownString(szDropdownName, localText.getText("TXT_KEY_WB_TEAM_DATA",(self.m_iCurrentTeam,)), 0, 0, True )
				screen.addPullDownString(szDropdownName, localText.getText("TXT_KEY_WB_GAME_DATA",()), 0, 0, True )
...
## Edit Area Map Start##
				...
				screen.addPullDownString(szDropdownName, localText.getText("TXT_KEY_WB_CHANGE_AREA_PLOTS",()), 1, 1, self.m_iPlotMode == 1)
				screen.addPullDownString(szDropdownName, localText.getText("TXT_KEY_WB_CHANGE_ALL_PLOTS",()), 2, 2, self.m_iPlotMode == 2)
