...
class C2CMainOptions:
	"A Blank Civ4 Screen"

	def __init__(self):
		self.sWidgetPrefix = "C2CMainOptions"
	...
	def getScreen(self):
		return CyGInterfaceScreen(self.MANAGER_SCREEN_ID, CvScreenEnums.C2C_INITIAL_OPTIONS_SCREEN)
	...
	def interfaceScreen(self):
		...
		sBackgroundPath = ArtFileMgr.getInterfaceArtInfo("C2C_INITIAL_OPTIONS_SCREEN_BACKGROUND").getPath()
