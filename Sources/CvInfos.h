...
/************************************************************************************************/
	...
	virtual void copyNonDefaultsReadPass2(CvInfoBase* pClassInfo = NULL , CvXMLLoadUtility* pXML = NULL){ /* AIAndy: Default implementation for full copy of info without knowledge of one/twopass */ }
/************************************************************************************************/
/* XMLCOPY                                 END                                                  */
/************************************************************************************************/
...
/************************************************************************************************/
	...
	int getNumTechSpecialistHappinesses() const;
	int getTechSpecialistHappiness(int iTech) const;

	int getNumTechSpecialistHealths() const;
	int getTechSpecialistHealth(int iTech) const;
	...
	bool isTechSpecialistHappinessType(int i, int j) const;
	bool isTechSpecialistHealthType(int i, int j) const;
	bool isTechSpecialistUnHappinessType(int i, int j) const;
	bool isTechSpecialistUnHealthType(int i, int j) const;
	bool isAnyTechSpecialistHappinessType() const;
	bool isAnyTechSpecialistHealthType() const;
	bool isAnyTechSpecialistUnHappinessType() const;
	bool isAnyTechSpecialistUnHealthType() const;
	bool isAnySpecialistCommerceChanges() const;
...
protected:
	bool** m_ppbTechSpecialistHappinessTypes;
	bool** m_ppbTechSpecialistHealthTypes;
	bool** m_ppbTechSpecialistUnHappinessTypes;
	bool** m_ppbTechSpecialistUnHealthTypes;
	bool m_bAnyTechSpecialistHappinessType;
	bool m_bAnyTechSpecialistHealthType;
	bool m_bAnyTechSpecialistUnHappinessType;
	bool m_bAnyTechSpecialistUnHealthType;
	bool* m_pabHurry;
...
/************************************************************************************************/
	...
	//bool
	bool isStronglyRestricted() const;//Means that the civilization cannot build or train anything which is not specified as allowed in Unit or Building Info by the EnabledCivilization tag.  Generally used for NPC players.
...
/************************************************************************************************/
	...
	static CRITICAL_SECTION			m_cTradeProvidingImprovementsCalcSection;
...
public:
	...
	bool read(CvXMLLoadUtility* pXML);
	bool readPass2(CvXMLLoadUtility* pXML);
	void copyNonDefaultsReadPass2(CvMapInfo* pClassInfo = NULL, CvXMLLoadUtility* pXML = NULL);
	bool readPass3();
...
public:
	...
	void copyNonDefaultsReadPass2(CvPromotionLineInfo* pClassInfo = NULL, CvXMLLoadUtility* pXML = NULL);
...
public:
	...
	void copyNonDefaultsReadPass2(CvMapCategoryInfo* pClassInfo = NULL, CvXMLLoadUtility* pXML = NULL);
...
public:
	...
	void copyNonDefaultsReadPass2(CvIdeaClassInfo* pClassInfo = NULL, CvXMLLoadUtility* pXML = NULL);
...
public:
	...
	void copyNonDefaultsReadPass2(CvIdeaInfo* pClassInfo = NULL, CvXMLLoadUtility* pXML = NULL);
...
public:
	...
	void copyNonDefaultsReadPass2(CvInvisibleInfo* pClassInfo = NULL, CvXMLLoadUtility* pXML = NULL);
