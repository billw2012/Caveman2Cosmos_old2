...
/************************************************************************************************/
	...
	SortAlphabetGlobalClassInfo(GC.getLeaderHeadInfos());
...
/************************************************************************************************/
	...
	SortAlphabetGlobalClassInfo(GC.getCivilizationInfos());
...
{
	RemoveTGABogusReligion(GC.getReligionInfos());
	RemoveTGABogusCorporation(GC.getCorporationInfos());
}
