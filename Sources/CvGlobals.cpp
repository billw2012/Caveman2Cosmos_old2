...
BoolExpr* cvInternalGlobals::getReplacementCondition()
{
	return m_pReplacementCondition;
}

void cvInternalGlobals::setReplacementCondition(BoolExpr *pExpr)
{
	SAFE_DELETE(m_pReplacementCondition);
	m_pReplacementCondition = pExpr;
}

int cvInternalGlobals::getReplacementID()
{
	return m_iReplacementID;
}

void cvInternalGlobals::setReplacementID(int iID)
{
	m_iReplacementID = iID;
}

void cvInternalGlobals::resetReplacement()
{
	m_pReplacementCondition = NULL;
	m_iReplacementID = -1;
}
