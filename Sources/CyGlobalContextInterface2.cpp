...
/************************************************************************************************/
		...
		.def("getLAST_PLAYER", &CyGlobalContext::getLAST_PLAYER, "int ()")
		...
		.def("getAGGRESSIVE_ANIMAL_PLAYER", &CyGlobalContext::getAGGRESSIVE_ANIMAL_PLAYER, "int ()")
		.def("getAGGRESSIVE_ANIMAL_TEAM", &CyGlobalContext::getAGGRESSIVE_ANIMAL_TEAM, "int ()")
		.def("getPASSIVE_ANIMAL_PLAYER", &CyGlobalContext::getPASSIVE_ANIMAL_PLAYER, "int ()")
		.def("getPASSIVE_ANIMAL_TEAM", &CyGlobalContext::getPASSIVE_ANIMAL_TEAM, "int ()")
		...
		.def("getNPC5_PLAYER", &CyGlobalContext::getNPC5_PLAYER, "int ()")
		.def("getNPC5_TEAM", &CyGlobalContext::getNPC5_TEAM, "int ()")
		.def("getNPC6_PLAYER", &CyGlobalContext::getNPC6_PLAYER, "int ()")
		.def("getNPC6_TEAM", &CyGlobalContext::getNPC6_TEAM, "int ()")
		.def("getNPC7_PLAYER", &CyGlobalContext::getNPC7_PLAYER, "int ()")
		.def("getNPC7_TEAM", &CyGlobalContext::getNPC7_TEAM, "int ()")
		.def("getNPC8_PLAYER", &CyGlobalContext::getNPC8_PLAYER, "int ()")
