...
,m_ppbTechSpecialistHappinessTypes(NULL)
,m_ppbTechSpecialistHealthTypes(NULL)
,m_ppbTechSpecialistUnHappinessTypes(NULL)
,m_ppbTechSpecialistUnHealthTypes(NULL)
,m_pabHurry(NULL)
//ls612 Begin
, m_iMaxPopAllowed(0)
, m_iMaxCultureLevelAllowed(0)
//ls612 End
,m_bAnyTechSpecialistHappinessType(false)
,m_bAnyTechSpecialistHealthType(false)
,m_bAnyTechSpecialistUnHappinessType(false)
,m_bAnyTechSpecialistUnHealthType(false)
//,m_pExprFreePromotionCondition(NULL)
,m_bNotShowInCity(false)
,m_ePropertySpawnUnitClass(NO_UNITCLASS)
...
//Team Project (1)
	...
	if (m_ppbTechSpecialistHappinessTypes != NULL)
	{
		for (int i=0;i<GC.getNumTechInfos();i++)
		{
			SAFE_DELETE_ARRAY(m_ppbTechSpecialistHappinessTypes[i]);
		}
		SAFE_DELETE_ARRAY(m_ppbTechSpecialistHappinessTypes);
	}
	if (m_ppbTechSpecialistHealthTypes != NULL)
	{
		for (int i=0;i<GC.getNumTechInfos();i++)
		{
			SAFE_DELETE_ARRAY(m_ppbTechSpecialistHealthTypes[i]);
		}
		SAFE_DELETE_ARRAY(m_ppbTechSpecialistHealthTypes);
	}
	if (m_ppbTechSpecialistUnHappinessTypes != NULL)
	{
		for (int i=0;i<GC.getNumTechInfos();i++)
		{
			SAFE_DELETE_ARRAY(m_ppbTechSpecialistUnHappinessTypes[i]);
		}
		SAFE_DELETE_ARRAY(m_ppbTechSpecialistUnHappinessTypes);
	}
	if (m_ppbTechSpecialistUnHealthTypes != NULL)
	{
		for (int i=0;i<GC.getNumTechInfos();i++)
		{
			SAFE_DELETE_ARRAY(m_ppbTechSpecialistUnHealthTypes[i]);
		}
		SAFE_DELETE_ARRAY(m_ppbTechSpecialistUnHealthTypes);
	}
...
UnitClassTypes CvBuildingInfo::getPropertySpawnUnitClass() const					
{
	return m_ePropertySpawnUnitClass;
}
...
int CvBuildingInfo::getNumTechSpecialistHappinesses() const
{
	return m_aTechSpecialistHappinesses.size();
}
...
int CvBuildingInfo::getNumTechSpecialistHealths() const
{
	return m_aTechSpecialistHealths.size();
}
...
bool CvBuildingInfo::isTechSpecialistHappinessType(int i, int j) const
{
	FAssertMsg(i < GC.getNumTechInfos(), "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	FAssertMsg(j < GC.getNumSpecialistInfos(), "Index out of bounds");
	...
	return (m_ppbTechSpecialistHappinessTypes && m_ppbTechSpecialistHappinessTypes[i]) ? m_ppbTechSpecialistHappinessTypes[i][j] : false;
}

bool CvBuildingInfo::isTechSpecialistHealthType(int i, int j) const
{
	FAssertMsg(i < GC.getNumTechInfos(), "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	FAssertMsg(j < GC.getNumSpecialistInfos(), "Index out of bounds");
	...
	return (m_ppbTechSpecialistHealthTypes && m_ppbTechSpecialistHealthTypes[i]) ? m_ppbTechSpecialistHealthTypes[i][j] : false;
}

bool CvBuildingInfo::isTechSpecialistUnHappinessType(int i, int j) const
{
	FAssertMsg(i < GC.getNumTechInfos(), "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	FAssertMsg(j < GC.getNumSpecialistInfos(), "Index out of bounds");
	...
	return (m_ppbTechSpecialistUnHappinessTypes && m_ppbTechSpecialistUnHappinessTypes[i]) ? m_ppbTechSpecialistUnHappinessTypes[i][j] : false;
}

bool CvBuildingInfo::isTechSpecialistUnHealthType(int i, int j) const
{
	FAssertMsg(i < GC.getNumTechInfos(), "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	FAssertMsg(j < GC.getNumSpecialistInfos(), "Index out of bounds");
	...
	return (m_ppbTechSpecialistUnHealthTypes && m_ppbTechSpecialistUnHealthTypes[i]) ? m_ppbTechSpecialistUnHealthTypes[i][j] : false;
}

bool CvBuildingInfo::isAnyTechSpecialistHappinessType() const
{
	return m_bAnyTechSpecialistHappinessType;
}

bool CvBuildingInfo::isAnyTechSpecialistHealthType() const
{
	return m_bAnyTechSpecialistHealthType;
}

bool CvBuildingInfo::isAnyTechSpecialistUnHappinessType() const
{
	return m_bAnyTechSpecialistUnHappinessType;
}

bool CvBuildingInfo::isAnyTechSpecialistUnHealthType() const
{
	return m_bAnyTechSpecialistUnHealthType;
}
...
/************************************************************************************************/
	...
	//TB Combat Mods (Buildings) begin
	CheckSum(iSum, m_ePropertySpawnUnitClass);
...
//Team Project (3)
	...
	CheckSum(iSum, m_bAnyTechSpecialistHappinessType);
	CheckSum(iSum, m_bAnyTechSpecialistHealthType);
	CheckSum(iSum, m_bAnyTechSpecialistUnHappinessType);
	CheckSum(iSum, m_bAnyTechSpecialistUnHealthType);
	//ls612 Begin
...
//Team Project (1)
	...
	CheckSumC(iSum, m_aTechSpecialistHappinesses);
	CheckSumC(iSum, m_aTechSpecialistHealths);
	//Arrays
	...
	for ( int j = 0; j < GC.getNumTechInfos(); j++ )
	{
		for ( int i = 0; i < GC.getNumSpecialistInfos(); i++ )
		{
			CheckSum(iSum, isTechSpecialistHappinessType(j,i));
		}
	}
	...
	for ( int j = 0; j < GC.getNumTechInfos(); j++ )
	{
		for ( int i = 0; i < GC.getNumSpecialistInfos(); i++ )
		{
			CheckSum(iSum, isTechSpecialistHealthType(j,i));
		}
	}
	...
	for ( int j = 0; j < GC.getNumTechInfos(); j++ )
	{
		for ( int i = 0; i < GC.getNumSpecialistInfos(); i++ )
		{
			CheckSum(iSum, isTechSpecialistUnHappinessType(j,i));
		}
	}
	...
	for ( int j = 0; j < GC.getNumTechInfos(); j++ )
	{
		for ( int i = 0; i < GC.getNumSpecialistInfos(); i++ )
		{
			CheckSum(iSum, isTechSpecialistUnHealthType(j,i));
		}
	}
...
/************************************************************************************************/
	...
	m_iBuildingClassType = pXML->GetInfoClass(szTextVal);
...
/************************************************************************************************/
	...
	//pXML->SetVariableListTagPair(&m_piHappinessTraits, L"HappinessTraits", GC.getNumTraitInfos());
	...
	m_iFreeBuildingClass = pXML->GetInfoClass(szTextVal);

	pXML->GetOptionalChildXmlValByName(szTextVal, L"FreeAreaBuilding");
	m_iFreeAreaBuildingClass = pXML->GetInfoClass(szTextVal);

	pXML->GetOptionalChildXmlValByName(szTextVal, L"FreeTradeRegionBuilding");
	m_iFreeTradeRegionBuildingClass = pXML->GetInfoClass(szTextVal);
...
/********************************************************************************/
	...
	pXML->SetVariableListTagPair(&m_piPrereqNumOfBuildingClass, L"PrereqBuildingClasses",  GC.getNumBuildingClassInfos());
...
//Team Project (1)
	...
	pXML->SetVariableListTagPair(&m_piBuildingHappinessChanges, L"BuildingHappinessChanges",  GC.getNumBuildingClassInfos());
...
/************************************************************************************************//*
	...
	pXML->GetOptionalChildXmlValByName(szTextVal, L"ProductionContinueBuildingClass");
	m_iProductionContinueBuildingClass = pXML->GetInfoClass(szTextVal);
	
	pXML->GetOptionalChildXmlValByName(szTextVal, L"PrereqAnyoneBuildingClass");
	m_iPrereqAnyoneBuildingClass = pXML->GetInfoClass(szTextVal);
	
	pXML->GetOptionalChildXmlValByName(szTextVal, L"ExtendsBuildingClass");
	m_iExtendsBuildingClass = pXML->GetInfoClass(szTextVal);
	...
	pXML->SetVariableListTagPair(&m_pbPrereqOrBuildingClass, L"PrereqOrBuildingClasses",  GC.getNumBuildingClassInfos());
	...
	pXML->SetVariableListTagPair(&m_pbReplaceBuildingClass, L"ReplaceBuildings",  GC.getNumBuildingClassInfos());
	...
	pXML->SetVariableListTagPair(&m_pbPrereqNotBuildingClass, L"PrereqNotBuildingClasses",  GC.getNumBuildingClassInfos());
	pXML->SetVariableListTagPair(&m_piBuildingClassProductionModifier, L"BuildingClassProductionModifiers",  GC.getNumBuildingClassInfos());
	pXML->SetVariableListTagPair(&m_piGlobalBuildingClassProductionModifier, L"GlobalBuildingClassProductionModifiers",  GC.getNumBuildingClassInfos());
...
/************************************************************************************************/
	...
	//TB Combat Mods (Buildings) begin
	pXML->GetOptionalChildXmlValByName(szTextVal, L"PropertySpawnUnitClass");
	m_ePropertySpawnUnitClass = (UnitClassTypes) pXML->GetInfoClass(szTextVal);
...
//Team Project (1)
	...
	if (pXML->TryMoveToXmlFirstChild(L"TechSpecialistHappinessTypes"))
	{
		int iNumSibs = pXML->GetXmlChildrenNumber();
		if (pXML->TryMoveToXmlFirstChild())
		{
			if (0 < iNumSibs)
			{
				pXML->Init2DBoolList(&m_ppbTechSpecialistHappinessTypes, GC.getNumTechInfos(), GC.getNumSpecialistInfos());
				for (int j=0;j<iNumSibs;j++)
				{
					...
					{
						// delete the array since it will be reallocated
						SAFE_DELETE_ARRAY(m_ppbTechSpecialistHappinessTypes[iIndex]);
						// if we can set the current xml node to it's next sibling
						if (pXML->TryMoveToXmlFirstChild(L"SpecialistType"))
						{
							...
							if (0 < iNumChildren)
							{
								pXML->CvXMLLoadUtility::InitList(&m_ppbTechSpecialistHappinessTypes[iIndex], GC.getNumSpecialistInfos());
								...
								if (pXML->GetChildXmlVal(szTag))
								{
									...
									if (iIndex2 > -1)
									{
										m_ppbTechSpecialistHappinessTypes[iIndex][iIndex2] = true;
									}
									if(!(iNumChildren <= GC.getNumSpecialistInfos()))
									{
										char	szMessage[1024];
	...
	FAssertMsg((GC.getNumTechInfos() > 0) && (GC.getNumSpecialistInfos()) > 0,"either the number of tech infos is zero or less or the number of specialist types is zero or less");
	if (pXML->TryMoveToXmlFirstChild(L"TechSpecialistHealthTypes"))
	{
			int iNumSibs = pXML->GetXmlChildrenNumber();
			if (pXML->TryMoveToXmlFirstChild())
			{
				if (0 < iNumSibs)
				{
					pXML->Init2DBoolList(&m_ppbTechSpecialistHealthTypes, GC.getNumTechInfos(), GC.getNumSpecialistInfos());
					for (int j=0;j<iNumSibs;j++)
					{
						pXML->GetChildXmlValByName(szTextVal, L"TechType");
						int iIndex = pXML->GetInfoClass(szTextVal);
						...
						{
							// delete the array since it will be reallocated
							SAFE_DELETE_ARRAY(m_ppbTechSpecialistHealthTypes[iIndex]);
							// if we can set the current xml node to it's next sibling
							if (pXML->TryMoveToXmlFirstChild(L"SpecialistType"))
							{
								// get the total number of children the current xml node has
								...
								if (0 < iNumChildren)
								{
									pXML->CvXMLLoadUtility::InitList(&m_ppbTechSpecialistHealthTypes[iIndex], GC.getNumSpecialistInfos());
									...
									if (pXML->GetChildXmlVal(szTag))
									{
										...
										if (iIndex2 > -1)
										{
											m_ppbTechSpecialistHealthTypes[iIndex][iIndex2] = true;
										}
										if(!(iNumChildren <= GC.getNumSpecialistInfos()))
										{
											char	szMessage[1024];
	...
	FAssertMsg((GC.getNumTechInfos() > 0) && (GC.getNumSpecialistInfos()) > 0,"either the number of tech infos is zero or less or the number of specialist types is zero or less");
	if (pXML->TryMoveToXmlFirstChild(L"TechSpecialistUnHappinessTypes"))
	{
		int iNumSibs = pXML->GetXmlChildrenNumber();
		if (pXML->TryMoveToXmlFirstChild())
		{
			if (0 < iNumSibs)
			{
				pXML->Init2DBoolList(&m_ppbTechSpecialistUnHappinessTypes, GC.getNumTechInfos(), GC.getNumSpecialistInfos());
				for (int j=0;j<iNumSibs;j++)
				{
					pXML->GetChildXmlValByName(szTextVal, L"TechType");
					int iIndex = pXML->GetInfoClass(szTextVal);
					...
					{
						// delete the array since it will be reallocated
						SAFE_DELETE_ARRAY(m_ppbTechSpecialistUnHappinessTypes[iIndex]);
						// if we can set the current xml node to it's next sibling
						if (pXML->TryMoveToXmlFirstChild(L"SpecialistType"))
						{
							// get the total number of children the current xml node has
							...
							if (0 < iNumChildren)
							{
								pXML->CvXMLLoadUtility::InitList(&m_ppbTechSpecialistUnHappinessTypes[iIndex], GC.getNumSpecialistInfos());
								...
								if (pXML->GetChildXmlVal(szTag))
								{
									...
									if (iIndex2 > -1)
									{
										m_ppbTechSpecialistUnHappinessTypes[iIndex][iIndex2] = true;
									}
									if(!(iNumChildren <= GC.getNumSpecialistInfos()))
									{
										char	szMessage[1024];
	...
	FAssertMsg((GC.getNumTechInfos() > 0) && (GC.getNumSpecialistInfos()) > 0,"either the number of tech infos is zero or less or the number of specialist types is zero or less");
	if (pXML->TryMoveToXmlFirstChild(L"TechSpecialistUnHealthTypes"))
	{
		int iNumSibs = pXML->GetXmlChildrenNumber();
		if (pXML->TryMoveToXmlFirstChild())
		{
			if (0 < iNumSibs)
			{
				pXML->Init2DBoolList(&m_ppbTechSpecialistUnHealthTypes, GC.getNumTechInfos(), GC.getNumSpecialistInfos());
				for (int j=0;j<iNumSibs;j++)
				{
					pXML->GetChildXmlValByName(szTextVal, L"TechType");
					int iIndex = pXML->GetInfoClass(szTextVal);
					...
					{
						// delete the array since it will be reallocated
						SAFE_DELETE_ARRAY(m_ppbTechSpecialistUnHealthTypes[iIndex]);
						// if we can set the current xml node to it's next sibling
						if (pXML->TryMoveToXmlFirstChild(L"SpecialistType"))
						{
							// get the total number of children the current xml node has
							...
							if (0 < iNumChildren)
							{
								pXML->CvXMLLoadUtility::InitList(&m_ppbTechSpecialistUnHealthTypes[iIndex], GC.getNumSpecialistInfos());
								...
								if (pXML->GetChildXmlVal(szTag))
								{
									...
									if (iIndex2 > -1)
									{
										m_ppbTechSpecialistUnHealthTypes[iIndex][iIndex2] = true;
									}
									if(!(iNumChildren <= GC.getNumSpecialistInfos()))
									{
										char	szMessage[1024];
			...
			if ( getLocalSpecialistYieldChange(i,j) == iDefault )
			{
				...
				if ( iChange != iDefault )
				{
					if ( m_ppaiLocalSpecialistYieldChange == NULL )
					{
						...
						for(int k = 0; k < GC.getNumSpecialistInfos(); k++)
						{
							m_ppaiLocalSpecialistYieldChange[k] = NULL;
						}
					}
					if ( m_ppaiLocalSpecialistYieldChange[i] == NULL )
					{
						m_ppaiLocalSpecialistYieldChange[i] = new int[NUM_YIELD_TYPES];
					}
			...
			if ( getLocalSpecialistCommerceChange(i,j) == iDefault )
			{
				...
				if ( iChange != iDefault )
				{
					if ( m_ppaiLocalSpecialistCommerceChange == NULL )
					{
						...
						for(int k = 0; k < GC.getNumSpecialistInfos(); k++)
						{
							m_ppaiLocalSpecialistCommerceChange[k] = NULL;
						}
					}
					if ( m_ppaiLocalSpecialistCommerceChange[i] == NULL )
					{
						m_ppaiLocalSpecialistCommerceChange[i] = new int[NUM_COMMERCE_TYPES];
					}
...
/************************************************************************************************/
	...
	//TB Combat Mods (Buildings) begin
	if (getPropertySpawnUnitClass() == NO_UNITCLASS) m_ePropertySpawnUnitClass = pClassInfo->getPropertySpawnUnitClass();
...
//Team Project (1)
	...
	if (getNumTechSpecialistHappinesses()==0)
	{
		for (int i=0; i < pClassInfo->getNumTechSpecialistHappinesses(); i++)
		{
			TechTypes eTech = ((TechTypes)i);
			int iChange = pClassInfo->getTechSpecialistHappiness(i);
			m_aTechSpecialistHappinesses.push_back(std::make_pair(eTech, iChange));
		}
	}
	
	if (getNumTechSpecialistHealths()==0)
	{
		for (int i=0; i < pClassInfo->getNumTechSpecialistHealths(); i++)
		{
			TechTypes eTech = ((TechTypes)i);
			int iChange = pClassInfo->getTechSpecialistHealth(i);
			m_aTechSpecialistHealths.push_back(std::make_pair(eTech, iChange));
		}
	}
	//Arrays
	for ( int j = 0; j < GC.getNumTechInfos(); j++ )
	{
		for ( int i = 0; i < GC.getNumSpecialistInfos(); i++ )
		{
			if (!isTechSpecialistHappinessType(j, i) && pClassInfo->isTechSpecialistHappinessType(j, i))
			{
				if ( NULL == m_ppbTechSpecialistHappinessTypes )
				{
					pXML->Init2DBoolList(&m_ppbTechSpecialistHappinessTypes, GC.getNumTechInfos(), GC.getNumSpecialistInfos());
				}
				else if ( NULL == m_ppbTechSpecialistHappinessTypes[i] )
				{
					CvXMLLoadUtility::InitList(&m_ppbTechSpecialistHappinessTypes[i],GC.getNumSpecialistInfos());
				}
				m_ppbTechSpecialistHappinessTypes[j][i] = pClassInfo->isTechSpecialistHappinessType(j, i);
			}
			if (isTechSpecialistHappinessType(j, i) || pClassInfo->isTechSpecialistHappinessType(j, i))
			{
				m_bAnyTechSpecialistHappinessType = true;
			}
		}
	}
	for ( int j = 0; j < GC.getNumTechInfos(); j++ )
	{
		for ( int i = 0; i < GC.getNumSpecialistInfos(); i++ )
		{
			if (!isTechSpecialistHealthType(j, i) && pClassInfo->isTechSpecialistHealthType(j, i))
			{
				if ( NULL == m_ppbTechSpecialistHealthTypes )
				{
					pXML->Init2DBoolList(&m_ppbTechSpecialistHealthTypes, GC.getNumTechInfos(), GC.getNumSpecialistInfos());
				}
				else if ( NULL == m_ppbTechSpecialistHealthTypes[i] )
				{
					CvXMLLoadUtility::InitList(&m_ppbTechSpecialistHealthTypes[i],GC.getNumSpecialistInfos());
				}
				m_ppbTechSpecialistHealthTypes[j][i] = pClassInfo->isTechSpecialistHealthType(j, i);
			}
			if (isTechSpecialistHealthType(j, i) || pClassInfo->isTechSpecialistHealthType(j, i))
			{
				m_bAnyTechSpecialistHealthType = true;
			}
		}
	}
	for ( int j = 0; j < GC.getNumTechInfos(); j++ )
	{
		for ( int i = 0; i < GC.getNumSpecialistInfos(); i++ )
		{
			if (!isTechSpecialistUnHappinessType(j, i) && pClassInfo->isTechSpecialistUnHappinessType(j, i))
			{
				if ( NULL == m_ppbTechSpecialistUnHappinessTypes )
				{
					pXML->Init2DBoolList(&m_ppbTechSpecialistUnHappinessTypes, GC.getNumTechInfos(), GC.getNumSpecialistInfos());
				}
				else if ( NULL == m_ppbTechSpecialistUnHappinessTypes[i] )
				{
					CvXMLLoadUtility::InitList(&m_ppbTechSpecialistUnHappinessTypes[i],GC.getNumSpecialistInfos());
				}
				m_ppbTechSpecialistUnHappinessTypes[j][i] = pClassInfo->isTechSpecialistUnHappinessType(j, i);
			}
			if (isTechSpecialistUnHappinessType(j, i) || pClassInfo->isTechSpecialistUnHappinessType(j, i))
			{
				m_bAnyTechSpecialistUnHappinessType = true;
			}
		}
	}
	for ( int j = 0; j < GC.getNumTechInfos(); j++ )
	{
		for ( int i = 0; i < GC.getNumSpecialistInfos(); i++ )
		{
			if (!isTechSpecialistUnHealthType(j, i) && pClassInfo->isTechSpecialistUnHealthType(j, i))
			{
				if ( NULL == m_ppbTechSpecialistUnHealthTypes )
				{
					pXML->Init2DBoolList(&m_ppbTechSpecialistUnHealthTypes, GC.getNumTechInfos(), GC.getNumSpecialistInfos());
				}
				else if ( NULL == m_ppbTechSpecialistUnHealthTypes[i] )
				{
					CvXMLLoadUtility::InitList(&m_ppbTechSpecialistUnHealthTypes[i],GC.getNumSpecialistInfos());
				}
				m_ppbTechSpecialistUnHealthTypes[j][i] = pClassInfo->isTechSpecialistUnHealthType(j, i);
			}
			if (isTechSpecialistUnHealthType(j, i) || pClassInfo->isTechSpecialistUnHealthType(j, i))
			{
				m_bAnyTechSpecialistUnHealthType = true;
			}
		}
	}
