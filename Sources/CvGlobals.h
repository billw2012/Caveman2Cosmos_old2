...
public:
	...
	void registerGOMs(void);
	void registerRelations(void);
	void registerAttributes(void);
	void registerTags(void);
	void registerPropertySources(void);
	void registerPropertyInteractions(void);
	void registerPropertyPropagators(void);
...
/************************************************************************************************/
	...
	BoolExpr* m_pReplacementCondition;
	int m_iReplacementID;
